...
We are going to learn using the C programming language, a relatively old computer language that still underlies the operations of many modern computers today.  
...
When people think of software they might think of their smartphone, or their laptop computer, or maybe even a workplace productivity tool or two. But information technology is deeply ingrained into the fabric of our world.

Almost every aspect of human endeavour nowadays is catalogued and managed through vast databases of information and the software designed to manage them. Computers (and computer programs) are used to further every science and industry, every frontier of human knowledge.  
...
Obfuscated inside the box is whatever algorithm, problem-solving processes, and computations the programmer implemented when they wrote the program.

The program is correct if it produces the expected and correct output for all inputs.
